...
var _APIToolkitAsync_topicName, _APIToolkitAsync_topic, _APIToolkitAsync_pubsub, _APIToolkitAsync_project_id, _APIToolkitAsync_config;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReportError = exports.APIToolkitAsync = exports.asyncLocalStorage = void 0;
...
class APIToolkitAsync {
    constructor(pubsub, topicName, project_id, config) {
        _APIToolkitAsync_topicName.set(this, void 0);
        _APIToolkitAsync_topic.set(this, void 0);
        _APIToolkitAsync_pubsub.set(this, void 0);
        _APIToolkitAsync_project_id.set(this, void 0);
        _APIToolkitAsync_config.set(this, void 0);
        __classPrivateFieldSet(this, _APIToolkitAsync_topicName, topicName, "f");
        __classPrivateFieldSet(this, _APIToolkitAsync_pubsub, pubsub, "f");
        __classPrivateFieldSet(this, _APIToolkitAsync_project_id, project_id, "f");
        __classPrivateFieldSet(this, _APIToolkitAsync_config, config, "f");
        if (__classPrivateFieldGet(this, _APIToolkitAsync_pubsub, "f")) {
            __classPrivateFieldSet(this, _APIToolkitAsync_topic, __classPrivateFieldGet(this, _APIToolkitAsync_pubsub, "f").topic(__classPrivateFieldGet(this, _APIToolkitAsync_topicName, "f")), "f");
        }
        this.publishMessage = (payload) => {
            const callback = (err, messageId) => {
                if (__classPrivateFieldGet(this, _APIToolkitAsync_config, "f").debug) {
                    console.log("APIToolkitAsync: pubsub publish callback called; messageId: ", messageId, " error ", err);
                    if (err != null) {
            ...
            if (__classPrivateFieldGet(this, _APIToolkitAsync_topic, "f")) {
                __classPrivateFieldGet(this, _APIToolkitAsync_topic, "f").publishMessage({ json: payload }, callback);
            }
            else {
                if (__classPrivateFieldGet(this, _APIToolkitAsync_config, "f").debug) {
                    console.error("APIToolkitAsync: error publishing message to pubsub, Undefined topic");
                }
            }
        };
    ...
    async close() {
        await __classPrivateFieldGet(this, _APIToolkitAsync_topic, "f")?.flush();
        await __classPrivateFieldGet(this, _APIToolkitAsync_pubsub, "f")?.close();
    }
    ...
    async expressMiddleware(req, res, next) {
        exports.asyncLocalStorage.run(new Map(), () => {
            ...
            exports.asyncLocalStorage.getStore().set("AT_project_id", __classPrivateFieldGet(this, _APIToolkitAsync_project_id, "f"));
            exports.asyncLocalStorage.getStore().set("AT_config", __classPrivateFieldGet(this, _APIToolkitAsync_config, "f"));
            ...
            const onRespFinished = (topic, req, res) => (err) => {
                ...
                const payload = (0, payload_1.buildPayload)(start_time, req, res, reqBody, respBody, __classPrivateFieldGet(this, _APIToolkitAsync_config, "f").redactRequestBody ?? [], __classPrivateFieldGet(this, _APIToolkitAsync_config, "f").redactResponseBody ?? [], __classPrivateFieldGet(this, _APIToolkitAsync_config, "f").redactHeaders ?? [], __classPrivateFieldGet(this, _APIToolkitAsync_project_id, "f"), errors, __classPrivateFieldGet(this, _APIToolkitAsync_config, "f").serviceVersion, __classPrivateFieldGet(this, _APIToolkitAsync_config, "f").tags ?? [], msg_id, undefined);
                if (__classPrivateFieldGet(this, _APIToolkitAsync_config, "f").debug) {
            ...
            const onRespFinishedCB = onRespFinished(__classPrivateFieldGet(this, _APIToolkitAsync_topic, "f"), req, res);
...
exports.APIToolkitAsync = APIToolkitAsync;
_APIToolkitAsync_topicName = new WeakMap(), _APIToolkitAsync_topic = new WeakMap(), _APIToolkitAsync_pubsub = new WeakMap(), _APIToolkitAsync_project_id = new WeakMap(), _APIToolkitAsync_config = new WeakMap();
function ReportError(error) {
    if (exports.asyncLocalStorage.getStore() == null) {
        console.log("APIToolkitAsync: ReportError used outside of the APIToolkitAsync middleware's scope. Use the APIToolkitAsyncClient.ReportError instead, if you're not in a web context.");
...
exports.default = APIToolkitAsync;
